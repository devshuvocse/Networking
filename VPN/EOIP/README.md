...
```
[admin@Main] > export
# 2025-11-19 07:24:46 by RouterOS 7.20.2
...
/interface eoip
add local-address=192.168.122.196 mac-address=FE:86:DE:1A:E8:05 name=EOIP-Tunnel-Interface \
    remote-address=192.168.122.250 tunnel-id=1
/ip pool
add name=dhcp_pool0 ranges=10.100.100.2-10.100.100.95
/ip dhcp-server
...
# 2025-11-19 07:27:47 by RouterOS 7.20.2
...
set [ find default-name=ether8 ] disable-running-check=no
/interface eoip
add local-address=192.168.122.250 mac-address=FE:BF:69:19:2F:94 name=EOIP-Tunnel-Interface \
    remote-address=192.168.122.196 tunnel-id=1
/ip pool
add name=dhcp_pool0 ranges=10.100.100.101-10.100.100.254
/ip dhcp-server
# DHCP server can not run on slave interface!
...
add bridge=EOIP-Bridge interface=EOIP-Tunnel-Interface
/ip address
add address=10.100.100.100/24 interface=ether2 network=10.100.100.0
/ip dhcp-client
add interface=ether1
/ip dhcp-server network
add address=10.100.100.0/24 gateway=10.100.100.100
/system identity
set name=Secondary
[admin@Secondary] > 
